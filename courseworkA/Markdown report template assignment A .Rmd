...
tweets_C <- searchTwitter("#TuckerCarlson", n=300, lang="en", resultType="recent") #300 recent tweets about Donald Trump, in English (I think that 1500 tweets is max)
tweets_T <- searchTwitter("#Trump", n=300, lang="en", resultType="recent") #300 recent tweets about Donald Trump
tweets_A <- searchTwitter("#aoc", n=300, lang="en", resultType="recent") #300 recent tweets about Hillary Clinton
tweets_B <- searchTwitter("#Bernie", n=300, lang="en", resultType="recent") #300 recent tweets about Bernie Sanders
tweets_J <- searchTwitter("#biden", n=300, lang="en", resultType="recent") #300 recent tweets about Bernie Sanders
...
#semFrame_more <- readRDS(file="semFrame.Rda")

#semFrame <- rbind(semFrame_more, semFrame)
...
We plot both a Boxplot and a distribution histogram which includes a mean line.
```{r}
...
```
As the model comparison shows that the predictor improves the fitting.
```{r}
pander(summary(model1))
```
The p-value of the Celeb variable is low (p < 0.001), so it appears that the celeb scraped has a real impact on the sentiment score.
```{r}
...
```
We see the pairs of trump-tucker, trump-bernie, trump-aoc, trump-biden differ sigificantly (p<0.001), while tucker-bernie, tucker-biden, bernie-aoc, bernie-biden and aoc-biden dont. 
